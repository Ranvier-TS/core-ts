...
exports.EffectableEntity = void 0;
 ...
 */
class EffectableEntity extends events_1.EventEmitter {
    constructor(data) {
        super();
        this.attributes = new Attributes_1.Attributes();
        this.__attributes = Object.assign({}, data.attributes);
        this.effects = new EffectList_1.EffectList(this, data.effects || []);
   ...
   * @param {number} currentAmount
    ...
    hydrate(state, serialized = {}) {
        if (this.__hydrated) {
            Logger_1.Logger.warn('Attempted to hydrate already hydrated entity.');
            return;
        }
        // Attribute Creation
...
exports.EffectableEntity = EffectableEntity;
