 ...
 * @extends GameEntity
 */
class Item extends GameEntity_1.GameEntity {
    constructor(area, item) {
        ...
        this.inventory = new Inventory_1.Inventory(item.inventory || {});
        ...
        if (typeof item.type === 'string') {
            ...
            this.type = item.type || ItemType_1.ItemType.OBJECT;
        }
     ...
     */
    initializeInventoryFromSerialized(inventory = {}) {
        this.inventory = new Inventory_1.Inventory(inventory);
    ...
    hydrate(state, serialized) {
        if (this.__hydrated) {
            Logger_1.Logger.warn('Attempted to hydrate already hydrated item.');
            return false;
        }
        ...
        if (serialized === null || serialized === void 0 ? void 0 : serialized.behaviors) {
        ...
        this.description = (serialized === null || serialized === void 0 ? void 0 : serialized.description) || this.description;
        this.keywords = (serialized === null || serialized === void 0 ? void 0 : serialized.keywords) || this.keywords;
        this.name = (serialized === null || serialized === void 0 ? void 0 : serialized.name) || this.name;
        this.roomDesc = (serialized === null || serialized === void 0 ? void 0 : serialized.roomDesc) || this.roomDesc;
        this.metadata = JSON.parse(JSON.stringify((serialized === null || serialized === void 0 ? void 0 : serialized.metadata) || this.metadata));
        this.closed = Boolean(serialized && 'closed' in serialized ? serialized.closed : this.closed);
        this.locked = Boolean(serialized && 'locked' in serialized ? serialized.locked : this.locked);
        ...
        if (this.inventory) {
            ...
            this.defaultItems.forEach((defaultItemId) => {
                if (typeof defaultItemId == 'string') {
                    Logger_1.Logger.verbose(`\tDIST: Adding item [${defaultItemId}] to item [${this.name}]`);
    ...
    serialize() {
        ...
        for (const behavior of this.behaviors) {
            const [key, val] = behavior;
            behaviors[key] = val;
        }
        return Object.assign(Object.assign(Object.assign({}, super.serialize()), { entityReference: this.entityReference, inventory: this.inventory && this.inventory.serialize(), 
            ...
            metadata: this.metadata, description: this.description, keywords: this.keywords, name: this.name, roomDesc: this.roomDesc, closed: this.closed, locked: this.locked, 
