...
export declare class Data {
     ...
     */
    static saveFile(filepath: string, data: any, callback?: Function | undefined): void;
    /**
     ...
     * @return {boolean}
     */
    static exists(type: string, id: string): any;
    /**
     ...
     * @return {boolean}
     */
    static isScriptFile(path: string, file: string): RegExpMatchArray | null;
    /**
