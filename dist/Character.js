 ...
 * @mixes Metadatable
 */
class Character extends Metadatable_1.Metadatable(EffectableEntity_1.EffectableEntity) {
    constructor(data) {
        super(data);
        this.name = data.name;
    ...
    equip(item, slot) {
        ...
        if (this.equipment.has(slot)) {
            throw new EquipErrors_1.EquipSlotTakenError();
        }
        if (item.isEquipped) {
            throw new EquipErrors_1.EquipAlreadyEquippedError();
        }
        if (this.inventory) {
    ...
    unequip(slot) {
        ...
        if (this.isInventoryFull()) {
            throw new Inventory_1.InventoryFullError();
        }
        const item = this.equipment.get(slot);
        if (!item) {
            throw new EquipErrors_1.EquipAlreadyEquippedError(`Slot ${slot} already unequipped.`);
        }
     ...
     */
    _setupInventory() {
        this.inventory = this.inventory || new Inventory_1.Inventory();
    ...
    serialize() {
        ...
        return Object.assign(super.serialize(), {
            level: this.level,
            name: this.name,
            room: ((_a = this.room) === null || _a === void 0 ? void 0 : _a.entityReference) || 'void',
        });
    }
    /**
     * @see {@link Broadcast}
