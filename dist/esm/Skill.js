...
import { CooldownError, NotEnoughResourcesError, PassiveError, } from './SkillErrors';
...
export class Skill {
    ...
    constructor(id, config, state) {
        const { configureEffect = (_) => _, cooldown = null, effect = null, flags = [], info = (_) => { }, initiatesCombat = false, name, requiresTarget = true, resource = null /* format [{ attribute: 'someattribute', cost: 10}] */, run = (_) => { }, targetSelf = false, type = SkillType.SKILL, options = {}, } = config;
        ...
        return {
            ...
            listeners: (state) => ({
                effectDeactivated: function () {
                    ...
                    Broadcast.sayAt(this.target, `You may now use <bold>${skillName}</bold> again.`);
                },
            }),
        };
    }
