...
export declare class QuestReward {
     ...
     * @param {Player} player
     */
    static reward(GameState: IGameState, quest: Quest, config: IQuestRewardDef, player: Player): void;
    /**
     * Render the reward
     * @return string
     */
    static display(GameState: IGameState, quest: Quest, config: IQuestRewardDef, player: Player): void;
}
