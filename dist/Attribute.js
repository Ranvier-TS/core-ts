...
exports.AttributeFormula = exports.Attribute = void 0;
/**
...
class Attribute {
     ...
     */
    constructor(name, base, delta, formula, metadata) {
        /** @property {number} delta Current difference from the base */
        this.delta = 0;
        /** @property {AttributeFormula} formula */
        this.formula = null;
...
class AttributeFormula {
    ...
    evaluate(attribute, character, ...args) {
...
exports.AttributeFormula = AttributeFormula;
